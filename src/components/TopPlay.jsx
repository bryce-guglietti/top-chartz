...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-[#479b6d] ${activeSong?.title === song?.title ? 'bg-[#479b6d]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
